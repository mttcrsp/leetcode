...
@Suite
struct MaximumProductOfThreeNumbersTests {
  @Test func testMaximumProduct1() {
    let input = [1, 2, 3]
    let output = 6
    #expect(MaximumProductOfThreeNumbers().maximumProduct(input) == output)
  }

  @Test func testMaximumProduct2() {
    let input = [1, 2, 3, 4]
    let output = 24
    #expect(MaximumProductOfThreeNumbers().maximumProduct(input) == output)
  }

  @Test func testMaximumProduct3() {
    let input = [1, -2, 3, -4]
    let output = 24
    #expect(MaximumProductOfThreeNumbers().maximumProduct(input) == output)
  }

  @Test func testMaximumProduct4() {
    let input = [-3, -4, -2, -1]
    let output = -6
    #expect(MaximumProductOfThreeNumbers().maximumProduct(input) == output)
  }

  @Test func testMaximumProduct5() {
    let input = [-1, -2, -3, 0]
    let output = 0
    #expect(MaximumProductOfThreeNumbers().maximumProduct(input) == output)
  }

  @Test func testMaximumProduct6() {
