...
final class MeanOfArrayAfterRemovingSomeElementsTests: XCTestCase {
  func testTrimMean1() {
    let input = [1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3]
    let output = 2.00000
    XCTAssertEqual(MeanOfArrayAfterRemovingSomeElements().trimMean(input), output, accuracy: 0.00001)
  }
