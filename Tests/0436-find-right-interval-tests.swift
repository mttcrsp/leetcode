...
@Suite
struct FindRightIntervalTests {
  @Test func testFindRightInterval1() {
    let input = [[1, 2]]
    let output = [-1]
    #expect(FindRightInterval().findRightInterval(input) == output)
  }

  @Test func testFindRightInterval2() {
    let input = [[3, 4], [2, 3], [1, 2]]
    let output = [-1, 0, 1]
    #expect(FindRightInterval().findRightInterval(input) == output)
  }

  @Test func testFindRightInterval3() {
    let input = [[1, 4], [2, 3], [3, 4]]
    let output = [-1, 2, -1]
    #expect(FindRightInterval().findRightInterval(input) == output)
  }

  @Test func testFindRightInterval4() {
